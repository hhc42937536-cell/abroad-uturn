...
CITY_CODES = {
    ...
    "胡志明": "SGN", "胡志明市": "SGN",
    "河內": "HAN",
    "峇里島": "DPS", "巴里島": "DPS", "峇里": "DPS", "bali": "DPS",
    "馬尼拉": "MNL",
    "宿霧": "CEB",
    "雅加達": "JKT",
    # 港澳中
    ...
    "奧克蘭": "AKL",
    # 國家名（對應首都/最大城市）
    "美國": "NYC", "日本": "TYO", "韓國": "SEL",
    "泰國": "BKK", "新加坡": "SIN", "馬來西亞": "KUL",
    "越南": "SGN", "印尼": "DPS", "菲律賓": "MNL",
    "英國": "LON", "法國": "PAR", "德國": "FRA",
    "義大利": "ROM", "西班牙": "BCN", "荷蘭": "AMS",
    "瑞士": "ZRH", "奧地利": "VIE", "捷克": "PRG",
    "澳洲": "SYD", "紐西蘭": "AKL",
    "加拿大": "YVR", "土耳其": "IST",
    "香港": "HKG", "澳門": "MFM",
    # 其他
