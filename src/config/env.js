...
export const env = {
  ...
  M7_TREND_MAX_AGE_DAYS: numberEnv('M7_TREND_MAX_AGE_DAYS', 180),
  ENABLE_M7_AUTO_REFRESH: booleanEnv('ENABLE_M7_AUTO_REFRESH', true),
  M7_AUTO_REFRESH_CRON: process.env.M7_AUTO_REFRESH_CRON || '0 8 1 * *',
  M7_AUTO_REFRESH_TIMEZONE: process.env.M7_AUTO_REFRESH_TIMEZONE || 'Asia/Taipei',
  M7_AUTO_HEADLINES_LIMIT: numberEnv('M7_AUTO_HEADLINES_LIMIT', 8)
};
